...
public class OutboundPortNodeRegister extends AbstractOutboundPort implements RegistrationCI  {
	
	public OutboundPortNodeRegister(ComponentI owner, String uri) throws Exception {
