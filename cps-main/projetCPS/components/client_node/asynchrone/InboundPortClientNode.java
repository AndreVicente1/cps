...
public class InboundPortClientNode extends AbstractInboundPort implements RequestResultCI {
	...
	public InboundPortClientNode(ComponentI owner, String uri, String plugin_uri) throws Exception{
    ...
    public InboundPortClientNode(ComponentI owner, String plugin_uri) throws Exception{
