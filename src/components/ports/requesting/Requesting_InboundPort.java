...
public class Requesting_InboundPort extends AbstractInboundPort implements RequestingCI {
	...
	public Requesting_InboundPort(ComponentI owner, String uri, String sync_pool_uri, String async_pool_uri, String plugin_uri) throws Exception{
	...
	public Requesting_InboundPort(ComponentI owner, String sync_pool_uri, String async_pool_uri, String plugin_uri) throws Exception{
