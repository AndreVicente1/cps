...
/**
 * Interpreter for our AST, it follows the Design Pattern Visitor
 */
public class Interpreter implements IVisitor{
	...
	public boolean visit(SBExp sExp, ExecutionStateI e) throws EvaluationException {
		...
		if (!(sd.getValue() instanceof Boolean)) {System.out.println("Sensor " + sensorId + " value is not of type Boolean to call SBExp"); return false;} 
